...
fs.writeFile('guideSecret.json', secret, 'utf8', function(err: any) {
    if (err) throw err;
...
// Generated new KeyPair. Wallet PublicKey:  3N4vNN5x7CLfMevDKgDok2LxJvoMcHusvVp76jVWDWiq
// Wallet PrivateKey: BnGT1GDbJWL9X1oDPx3U3hJXPz5zdKvhXAmZwxyR6Jb6JKDik1jhxtmTihr1K6VgHc5K8TjTgzWH8SmanXshQah
// Wrote secret key to guideSecret.json.
// Airdrop Transaction Id: 5XLATZkAkMc2Q2GQmmQapxmXoUThGDg1R1qA5pheK9HxHVekS9rR2QG3dpUivBrwSTzxjXYnQkvFPWugBiB5uY8s
// https://explorer.solana.com/tx/5XLATZkAkMc2Q2GQmmQapxmXoUThGDg1R1qA5pheK9HxHVe